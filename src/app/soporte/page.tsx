...
<div className="max-w-3xl mx-auto px-4 text-center">
        ...
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-gray-800 mb-4">Mesa de ayuda PAS</h2>
          <div className="h-1 w-24 bg-red-600 mx-auto rounded"></div>
        </div>
        
        <p className="text-lg mb-6 text-gray-800">
        Si tenés algún problema con el sistema de Evolución Seguros, estamos acá para ayudarte. ✨ Completá este formulario y nuestro equipo te dará una mano lo más rápido posible. 🛠️💙

¡Queremos que tu experiencia sea siempre la mejor! 💪😊
