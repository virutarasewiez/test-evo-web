...
export default function Home() {
  const seguros = [
    // { label: "Protección Personal", icon: "bi-person", href: "/seguros/productos/proteccion-personal" },
    { label: "Vida Colectivo", icon: "bi-people", href: "/seguros/productos/pp-vidacolectivo" },
    { label: "Sepelio", icon: "bi-heartbreak", href: "/seguros/productos/pp-sepelio" },
    { label: "Accidentes Personales", icon: "bi-exclamation-triangle", href: "/seguros/productos/pp-accidentespersonales" },
    { label: "Garantía de Alquiler", icon: "bi-key", href: "/seguros/productos/pp-garantiadealquiler" },
