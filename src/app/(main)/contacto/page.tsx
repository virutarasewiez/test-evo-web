          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-shadow">
              <div className="text-center">
                ...
                <p className="text-2xl font-semibold text-red-600">0800-345-7373</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-shadow">
              <div className="text-center">
                ...
                <p className="text-2xl font-semibold text-red-600 mb-2">(5411) 5278 – 3600</p>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200 hover:shadow-xl transition-shadow">
              <div className="text-center">
                ...
                <a href="https://wa.me/5491126589562" target="_blank" rel="noopener noreferrer" className="text-2xl font-semibold text-red-600 hover:text-red-700 transition-colors">
                  54 911 2658 9562
                </a>
              </div>
            </div>
