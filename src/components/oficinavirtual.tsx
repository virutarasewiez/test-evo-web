export default function Oficinavirtual() {
  const items = [
    { icon: "bi-person-circle", label: "Ingreso Clientes", href: "https://ingresopas.evolucionseguros.com/", target: "_blank", rel: "noopener noreferrer" },
